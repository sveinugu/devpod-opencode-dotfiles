...
require_workspace_pod 'test_opencode_provider_policy_contract' 'bash tests/context/run.sh pod-inside-nono'
require_inside_nono_sandbox 'test_opencode_provider_policy_contract' 'bash tests/context/run.sh pod-inside-nono'
...
yellow_expected = [
    ...
    ('NorMistral 11B', 'norallm/normistral-11b-thinking'),
