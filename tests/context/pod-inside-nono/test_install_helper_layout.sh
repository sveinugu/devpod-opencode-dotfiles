...
require_workspace_pod 'test_install_helper_layout' 'bash tests/context/run.sh pod-inside-nono'
require_inside_nono_sandbox 'test_install_helper_layout' 'bash tests/context/run.sh pod-inside-nono'
