...
require_workspace_pod 'test_managed_worktree_lane_safety_policy' 'bash tests/context/run.sh pod-inside-nono'
require_inside_nono_sandbox 'test_managed_worktree_lane_safety_policy' 'bash tests/context/run.sh pod-inside-nono'
