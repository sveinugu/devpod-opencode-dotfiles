...
temp_root="$(context_resolve_temp_root_workspace_or_fail 'test_workspace_navigation_shell')"
tmpdir="$(context_make_test_tmpdir "$temp_root" 'test_workspace_navigation_shell')"
