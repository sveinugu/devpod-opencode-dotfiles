...
**Drift test**
- Create: `tests/pod-inside-nono/test_clean_code_policy_contract.sh`
...
7. `tests/pod-inside-nono/test_clean_code_policy_contract.sh` fails before the policy/config edits and passes afterward.
...
- Review only: `../../../tests/pod-inside-nono/test_clean_code_policy_contract.sh`
...
**Verification:**
- `bash tests/pod-inside-nono/test_clean_code_policy_contract.sh && bash tests/pod-inside-nono/test_bare_hub_guardrails.sh && bash tests/pod-inside-nono/test_delegation_packet_policy_contract.sh && bash tests/pod-inside-nono/test_maestro_intent_preservation_policy.sh`
- `git diff -- .config/opencode/AGENTS.md .config/opencode/PULL_REQUEST_TEMPLATE.md .config/opencode/skills-lock.json tests/pod-inside-nono/test_clean_code_policy_contract.sh`
...
- [ ] `bash tests/pod-inside-nono/test_delegation_packet_policy_contract.sh`
- [ ] `bash tests/pod-inside-nono/test_maestro_intent_preservation_policy.sh`
- [ ] `git diff -- .config/opencode/AGENTS.md .config/opencode/skills-lock.json tests/pod-inside-nono/test_clean_code_policy_contract.sh`
