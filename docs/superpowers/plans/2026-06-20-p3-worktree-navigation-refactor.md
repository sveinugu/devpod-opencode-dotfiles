...
- Create: `tests/pod-inside-nono/test_worktree_refactor_layout.sh` — structural contract for the new helper layout and thin-entrypoint call order.
...
**Files:**
- Create: `tests/pod-inside-nono/test_worktree_refactor_layout.sh`
...
bash tests/pod-outside-nono/test_workspace_navigation_path_contract.sh
...
Create `../../../tests/pod-inside-nono/test_worktree_refactor_layout.sh` with this exact content:
...
```bash
bash tests/pod-inside-nono/test_worktree_refactor_layout.sh
```
...
```bash
git add tests/pod-inside-nono/test_worktree_refactor_layout.sh
...
- Test: `../../../tests/pod-inside-nono/test_worktree_refactor_layout.sh`
...
- Move current lines `71-105` into `new_worktree_resolve_repo_context`; split the current hub-vs-child layout variables into one coherent block that sets these globals and nothing else: `new_worktree_repo_root`, `new_worktree_bare_dir`, `new_worktree_repo_default_branch`, `new_worktree_repo_default_dir`, `new_worktree_target`, `new_worktree_state_dir`, `new_worktree_tmp_dir`, `new_worktree_hub_kind`, `new_worktree_repo_for_env`, and `new_worktree_lane_repo_identity`.
