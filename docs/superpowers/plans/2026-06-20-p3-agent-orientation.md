...
- Test: `tests/pod-inside-nono/test_delegation_packet_policy_contract.sh`
- Test: `tests/pod-inside-nono/test_maestro_intent_preservation_policy.sh`
- Test: `tests/pod-inside-nono/test_multi_question_interaction_policy.sh`
- Test: `tests/pod-inside-nono/test_managed_worktree_lane_safety_policy.sh`
- Test: `tests/pod-inside-nono/test_clean_code_policy_contract.sh`
