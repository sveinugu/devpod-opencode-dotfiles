...
**Tech Stack:** Markdown runbooks, one Bash doc-contract test under `tests/docs/`, and `rg`-based anchor checks modeled after `tests/pod-inside-nono/test_p1_docs_orientation.sh`.
...
- Existing docs-contract pattern: `tests/pod-inside-nono/test_p1_docs_orientation.sh`
- Primary surfaces:
...
- Create: `tests/pod-inside-nono/test_p2_runbook_consolidation.sh` — locks HOST/POD routing anchors, canonical section ownership, wrapper-first guidance, and the absence of the worst duplicate sections.
...
**Files:**
- Create: `tests/pod-inside-nono/test_p2_runbook_consolidation.sh`
...
```bash
bash tests/pod-inside-nono/test_p2_runbook_consolidation.sh
```
...
```bash
git add tests/pod-inside-nono/test_p2_runbook_consolidation.sh
...
- Test: `../../../tests/pod-inside-nono/test_p2_runbook_consolidation.sh`
...
- Review only: `../../../tests/pod-inside-nono/test_p2_runbook_consolidation.sh`
...
- changed files: the three runbooks plus `../../../tests/pod-inside-nono/test_p2_runbook_consolidation.sh`
