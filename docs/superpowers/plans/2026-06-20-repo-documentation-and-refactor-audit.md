...
- Create: `../../../tests/pod-inside-nono/test_repo_documentation_refactor_audit.sh` — doc-contract test that locks the audit artifact structure and required headings.
- Review only:
  - `README.md`
  - `devspace.yaml`
  - `install.sh`
...
**Files:**
- Create: `../../../tests/pod-inside-nono/test_repo_documentation_refactor_audit.sh`
...
- [ ] **Step 2: Verify RED**
  - Run:
    ...
    ```bash
    bash tests/pod-inside-nono/test_repo_documentation_refactor_audit.sh
    ```
...
- Review only: `../../../tests/pod-inside-nono/test_repo_documentation_refactor_audit.sh`
...
- [ ] **Step 5: Mandatory refactor checkpoint for the artifact itself**
  ...
  - Keep the meaning unchanged and rerun `bash tests/pod-inside-nono/test_repo_documentation_refactor_audit.sh` after cleanup.
