...
### Verification
- Create: `tests/pod-inside-nono/test_maestro_intent_preservation_policy.sh`
...
Run: `bash tests/pod-inside-nono/test_maestro_intent_preservation_policy.sh`
...
```bash
git add .config/opencode/AGENTS.md tests/pod-inside-nono/test_maestro_intent_preservation_policy.sh
...
- Modify: `.config/opencode/AGENTS.md`
- Modify: `docs/superpowers/templates/subagent-handoff-templates.md`
- Modify: `../../../tests/pod-inside-nono/test_maestro_intent_preservation_policy.sh`

- [ ] **Step 1: Extend the failing contract test for restatement and templates**

Add these checks to `../../../tests/pod-inside-nono/test_maestro_intent_preservation_policy.sh`:
...
```bash
git add .config/opencode/AGENTS.md docs/superpowers/templates/subagent-handoff-templates.md tests/pod-inside-nono/test_maestro_intent_preservation_policy.sh
...
```bash
git add .config/opencode/agents/maestro.md tests/pod-inside-nono/test_maestro_intent_preservation_policy.sh
...
```bash
git add .config/opencode/AGENTS.md .config/opencode/agents/maestro.md tests/pod-inside-nono/test_maestro_intent_preservation_policy.sh
...
```bash
git add .config/opencode/AGENTS.md .config/opencode/agents/maestro.md docs/superpowers/templates/subagent-handoff-templates.md tests/pod-inside-nono/test_maestro_intent_preservation_policy.sh
...
- [ ] Run `bash tests/pod-inside-nono/test_maestro_intent_preservation_policy.sh`
- [ ] Run `git diff -- .config/opencode/AGENTS.md .config/opencode/agents/maestro.md docs/superpowers/templates/subagent-handoff-templates.md tests/pod-inside-nono/test_maestro_intent_preservation_policy.sh`
