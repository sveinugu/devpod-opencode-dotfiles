...
- Create: `tests/pod-inside-nono/test_install_helper_layout.sh` — locks the new helper-file layout and the thin-orchestrator call order.
- Modify: `install.sh` — becomes the thin orchestrator while preserving the existing top comment block.
- Modify: `tests/pod-outside-nono/test_install_local_source_contract.sh` — copies the new helper files into synthetic workspaces before invoking the refactored installer.
- Modify: `tests/pod-outside-nono/test_install_oh_my_zsh_failure_surface.sh` — copies the new helper files into the synthetic checkout before invoking the refactored installer.
- Modify: `tests/host/test_workspace_repair.sh` — moves the file-based oh-my-zsh guard assertion from top-level `install.sh` to `scripts/lib/install/materialize.sh`.
- Verify only:
  - `tests/pod-outside-nono/test_install_validate_source.sh`
  - `tests/pod-inside-nono/test_read_install_env.sh`
  - `tests/pod-outside-nono/test_workspace_navigation_shell.sh`
...
**Files:**
- Create: `tests/pod-inside-nono/test_install_helper_layout.sh`
...
```bash
bash tests/pod-inside-nono/test_install_helper_layout.sh
```
...
```bash
git add tests/pod-inside-nono/test_install_helper_layout.sh
...
- Modify: `../../../tests/pod-outside-nono/test_install_oh_my_zsh_failure_surface.sh`
- Modify: `../../../tests/host/test_workspace_repair.sh`
- Test: `../../../tests/pod-inside-nono/test_install_helper_layout.sh`
...
- Test: `../../../tests/pod-inside-nono/test_read_install_env.sh`
- Test: `../../../tests/pod-outside-nono/test_install_oh_my_zsh_failure_surface.sh`
...
In `../../../tests/pod-outside-nono/test_install_local_source_contract.sh`, insert this helper function immediately after `unset HUB_INSTALL_BRANCH HUB_INSTALL_BRANCH_DIR`:
...
In `../../../tests/pod-outside-nono/test_install_oh_my_zsh_failure_surface.sh`, replace the existing two-line copy block under `mkdir -p "$source_root/.config/opencode" "$source_root/scripts/lib" "$home_dir" "$bin_dir"` with this exact block:
...
In `../../../tests/host/test_workspace_repair.sh`, replace the current top-of-file install guard setup with this exact block:
...
bash tests/pod-inside-nono/test_read_install_env.sh
bash tests/pod-outside-nono/test_install_oh_my_zsh_failure_surface.sh
...
- Review only: `../../../tests/pod-inside-nono/test_install_helper_layout.sh`
- Review only: `../../../tests/pod-outside-nono/test_install_local_source_contract.sh`
- Review only: `../../../tests/pod-outside-nono/test_install_oh_my_zsh_failure_surface.sh`
- Review only: `../../../tests/host/test_workspace_repair.sh`
...
- changed files: `install.sh`, `scripts/lib/install/*.sh`, `../../../tests/pod-inside-nono/test_install_helper_layout.sh`, `../../../tests/pod-outside-nono/test_install_local_source_contract.sh`, `../../../tests/pod-outside-nono/test_install_oh_my_zsh_failure_surface.sh`, `../../../tests/host/test_workspace_repair.sh`
...
- Keep the top comment block in `install.sh` exactly as it is now so `../../../tests/pod-inside-nono/test_p1_docs_orientation.sh` remains green.
