...
- Modify or delete: `tests/pod-inside-nono/test_maestro_intent_preservation_policy.sh`
...
- [ ] If `../../../tests/pod-inside-nono/test_maestro_intent_preservation_policy.sh` survives Task 1, run `bash tests/pod-inside-nono/test_maestro_intent_preservation_policy.sh`.
...
- [ ] `git diff -- .config/opencode/AGENTS.md .config/opencode/agents/maestro.md tests/pod-inside-nono/test_delegation_packet_policy_contract.sh tests/pod-inside-nono/test_maestro_intent_preservation_policy.sh`
