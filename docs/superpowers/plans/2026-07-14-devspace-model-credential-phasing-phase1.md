...
- Verify against: `../../../tests/pod-inside-nono/test_workspace_manifest_contract.sh` and the new Phase 1 contract test
...
- `bash tests/pod-inside-nono/test_bare_hub_guardrails.sh` if runbook wording is extended there
- `bash tests/pod-inside-nono/test_devspace_command_surface.sh` if `devspace.yaml` guidance changes
